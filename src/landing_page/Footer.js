  ...
  return (
    ...
    <div className="container border-top mt-5">
      ...
      <p>
        ...
        Commodities Pvt. Ltd. – SEBI Registration no.: INZ000038238 Registered
        Address: Zerodha Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp.
      ...
      <p>
        ...
        <a href="mailto:dp@zerodha.com" class="text-blue-600 hover:underline">
          dp@zerodha.com
        </a>
      ...
      <p>
        ...
        on SCORES: Name, PAN, Address, Mobile Number, and Email ID.
        <br />
      ...
      <p>
        ...
        transactions directly from the Exchange on your mobile/email at the end
      ...
      <p>
        Dear Investor, in case you are subscribing to an IPO, there is no need
        to issue a cheque. Please write the bank account number and sign the IPO
